...
export default function Card(props) {
    const { cardDetails, isDarkMode } = props;

  return (
    <>
        <div className={`card-container cert ${isDarkMode ? 'dark-mode' : ''}`}>
            <div className="cert-view">
            {/* Display card ID, user profile, and availability */}
            ...
            {/* Display priority icon and tags */}
            <div className="card-tag ">
                {/* Display priority icon based on the priority level */}
                {
                    {
