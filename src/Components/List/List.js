  ...
  return (
    <>
        <div className="list-container">
            {/* List header with icons and title */}
            <div className="list-header">
                <div className="list-header-left">
                    {/* Display specific icons based on the list title */}
                    {
                        {
                            'status' : <>{
                                {
                ...
                {/* List header options for adding and configuring items */}
            ...
            <div className="list-card-items">
                {
                    props.ticketDetails.map(ticket => {
                        // Check if the ticket matches the current list title
                        if(ticket.status === props.listTitle){
                            cardCount++;
                            return(<Card cardDetails={ticket} isDarkMode={props.isDarkMode} />)
                        }
